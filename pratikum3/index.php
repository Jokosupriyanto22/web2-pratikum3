                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input name="gender" id="radio_0" type="radio" class="custom-control-input"
                                        value="Laki - Laki">
                                    <label for="radio_0" class="custom-control-label">Laki - Laki</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input name="gender" id="radio_1" type="radio" class="custom-control-input"
                                        value="Perempuan">
    ...
    <div class="row mt-5">
        ...
        <div class="col-md-12">
            <table class="table table-striped">
                ...
                $pasien2 = new BMIPasien(" Joko ", 51, 160, 20, "Laki - Laki");
                $pasien3 = new BMIPasien(" Supri", 70, 167, 19, "Laki - Laki");
                $pasien4 = new BMIPasien(" Yanto", 45, 154, 19, "Perempuan");
                $pasien5 = new BMIPasien(" Jack", 47, 164, 19, "Laki - Laki");
